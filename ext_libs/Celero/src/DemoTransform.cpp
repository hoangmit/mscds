...
BASELINE_F(DemoTransform, ForLoop, DemoTransformFixture, 0, 100)
{
	for(int i = 0; i < this->arraySize; i++)
	{
...
BENCHMARK_F(DemoTransform, StdTransform, DemoTransformFixture, 0, 100)
{
...
BENCHMARK_F(DemoTransform, StdTransformLambda, DemoTransformFixture, 0, 100)
{
...
BENCHMARK_F(DemoTransform, SelfForLoop, DemoTransformFixture, 0, 100)
{
	for(int i = 0; i < this->arraySize; i++)
	{
...
BENCHMARK_F(DemoTransform, SelfStdTransform, DemoTransformFixture, 0, 100)
{
...
BENCHMARK_F(DemoTransform, SelfStdTransformLambda, DemoTransformFixture, 0, 100)
{
